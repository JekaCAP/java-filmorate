...
class FilmorateApplicationTests {
    ...
    public void testCreateFilmAndGetFilmById() {
        Film createdFilm = filmStorage.createFilm(firstFilm);
    ...
    public void testGetFilms() {
        Film createdFirstFilm = filmStorage.createFilm(firstFilm);
        Film createdSecondFilm = filmStorage.createFilm(secondFilm);
        Film createdThirdFilm = filmStorage.createFilm(thirdFilm);
    ...
    public void testUpdateFilm() {
        ...
        Film updatedFilm = filmStorage.updateFilm(updateFilm);
    ...
    public void testDeleteFilm() {
        Film createdFirstFilm = filmStorage.createFilm(firstFilm);
        filmStorage.deleteFilm(createdFirstFilm.getId());
        List<Film> listFilms = filmStorage.getAllFilms();
